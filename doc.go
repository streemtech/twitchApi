...
//go:generate go run github.com/vektra/mockery/v2@v2.42.2 --name ClientWithResponsesInterface --output ./mocks --with-expecter --filename api.gen.go --structname Api
